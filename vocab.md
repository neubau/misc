**foutre la gueule de qn**  not talk to sb \
...
**en un éclair**   in the twinkling of an eye; \
...
**avachi**  which has lost its shape; flabby \
...
**convoitise**  covetousness, desire \
...
**faire des frayeurs à qn**   to give sb a fright \
...
**chalumeau**  blowtorch / pipe / straw \
**un capteur**  sensor \
...
**le caleçon**  boxer shorts, underpants \
...
**bataclan**  stuff; junk \
**avoir du plomb dans l'aile** *inf.* to be in a bad way \
...
**la caution**   soutien, backing / guarantee (morale) \
...
**effectuer un repli stratégique**  to effect a strategic withdrawal \
...
**c'est à sens unique**  literal it's one-way; *fig.* it's one-sided \
...
**foisonner** (**de)** to abound (with), be teeming (with) \
...
**un roseau**  reed \
**en demi-teinte**  in muted colors, *fig.* subdued \
...
**il m'a été d'un grand <u>réconfort</u>**  he was a great comfort to me \
...
**grisant** exhilarating, intoxicating \
...
**les ressorts du pouvoir/de la haine**   the impulse behind power/hatred \
...
**faire qch derrière le dos de qn**  to do sth when sb's back is turned \
**la vétille**  trifle, Chose sans importance \
**lévrier**  greyhound \
**faire la culbute**  somersault \
**cela se pourrait bien**   very possibly so \
**gominer**  to slick one's hair back \
**faire qch au quart de tour**  *fig.* to do sth immediately \
**partout ailleurs**  everywhere else \
**tortiller du derrière / des fesses**  to wiggle one's bottom \
**ravalement de façade**  renovate a façade; *fig.* to do a repair job on one's face \
**dodu**  chubby \
**la mouche**  fly; (de cible) bull's eye \
**s'emparer de** to take over, to get hold of, to seize \
**s'empoigner avec qn**  to grapple with sb \
**éperdu de**  overcome with \
**un escabeau**  step ladder \
...
**fourrage**  forage \
**rayer qch de sa conscience**  to blot sth out from one's mind \
**la traite des vaches** cow milking \
**la hontise**  dread \
**ce vin écorche le gosier**  this wine is like paint stripper \
**étouffer les velléités de réforme**   to put down any vague attempts at reform \
**un faitout**  stockpot \
**nous avons abordé à Venise**  we have landed in Venice \
**son acharnement au travail**   the fact that he/she works so relentlessly \
**le cachot**  prison cell / dungeon / prison \
**enlacer**  to embrace \
**coup de gueule**  shout \
**déchetterie**  waste reception centre, dump \
**nous voulions du soleil, nous sommes servis**  we wanted some sunshine and we've certainly got it \
**le fauve**  wild animal; big cat \
**pour une bouchée de pain** (buy) for a song \
**malmener**   to manhandle \
**une entorse**  sprain \
**sortir les pieds devant**   to leave feet first \
**un engouement pour qn**  an infatuation for sb \
**j'ai les jambes coupées**  my legs feel like lead \
**nasiller**  to speak with a nasal voice / to quack \
**être grisé par la vitesse**  to be exhilarated by speed \
**besogneux**  laborious; *dated* poor \
**se requinquer** to perk up \
**assommant** deadly boring \
**dévaliser**  to rob; to clean out \
**de traviole**  crooked, lopsided \
**être bon pour le cabanon**  to be fit for the loony bin \
**l'estrade**  f. platform \
**la lange**  swaddling clothes / nappy, diaper \
**sourdre**  to seep out of (de) / to well up from (de) / *fig.* to take shape (idea etc) \
**la tuile**  tile; misfortune (quelle tuile!) \
**boiter**  to limp \
**les amarres**  moorings
**s'amocher le nez**  to bash up one's nose \
**cordée**  roped party (of climbers) \
**un bobard**  fib \
**basse-fosse**  dungeon \
**la rame**  oar; (métro, train) train \
**gosier**  throat, gullet \
**griser**  to exhilarate, intoxicate \
**les touristes en débardeur**  tourists in sleeveless tee-shirts \
**potache**  schoolboy \
**éperdu de**  overcome with \
**la couille molle**  wimp \
**cagoulé**  wearing a balaclava (après n), hooded \
**cuisant**  bitter, stinging \
**remise**  hand-over \
**la pieuvre** octopus  \
**baroud**  fighting \
**brouter**  to graze, nibble \
**ça a été limite mais j'ai eu mon avion**  I managed to catch my plane but it was a close thing \
**je m'en bat les couilles**  = je m'en fou \
**sens unique**  one-way street \
**les plombs ont sauté**  the fuses have blown \
**le pif**  slang nose, schnozz; intuition \
**entrave à**  hindrance to \
**la maison est grevée d'hypothèques**  the house is mortgaged to the hilt \
**la moyenne**  n. average \
**j'en suis resté coi**   it left me speechless \
**épandage** (Farming) spreading; sewage-farming \
**la jauge d'essence**  gas gauge \
**se décommander (en raison de)**  to excuse onself from an appointment (because of) \
**faire craquer une allumette**   to strike a match \
**un froussard**  coward
**rêvasser**  to daydream \
**c'est (du) n'importe quoi**  it's rubbish \
**les mômeries**  childishness \
**musicien en herbe**  budding musician \
**le chevron**  (poutre) rafter / (motif) chevron, herringbone-pattern \
**arme à feu**   firearm \
**se parer** to take precautions (**contre** against); to array oneself; to be bedecked (**de** with) \
**je n'en reviens pas**  I can't get over it; I'm amazed \
**la brasse**  breaststroke / unit, ≈ 160 cm
**chicaner qn sur qch**  to argue with sb about sth \
**volée de bois vert**  a blistering critique \
**mainmise sur**  control over \
**quitte à**  *(au risque de)* even if it means that... \
**blet**  overripe \
**réclamer**  to ask for, call for \
**la tenaille**  pincers \
**sourdre de**  to seep out from, ooze from \
**l'oued**  wadi  \
**mettre les mains dans le cambouis**  to get one's hands dirty \
**assainir**  to clean up / to stabilize \
**goujat**  boor \
**la trousse**  (little) case / kit \
**damer le pion à qn**  to trump sb \
**tacler**  to tackle \
**stop ou encore**  music radio show, but also *fig.* \
**réclamer à cor et à cri**  to clamour for sth \
**affût**  *Hunting* hide \
**boiteux**  lame, wobbly \
**le rimmel**  mascara \
**des mollets de coq**  legs like sticks \
**ferrailler contre tabagisme**  _fig._ to fight against tobacco addiction \
**foutre qn dehors**   to kick sb out \
**l'intercours**  pause between courses, Hohlstunde \
**saturnisme**  lead poisoning \
**miroiter**  to sparkle; to shimmer \
**l'élytre**  elytron, each of the two wing cases of a beetle \
**agréer qch**  to agree to [demande]; to recognize [sb] officially, to approve \
**périr piétiné**   to be trampled to death \
**la grand-route**  main road, highroad \
**la tenture**  curtain, drape; fabric wall covering \
**desserrer**  to loosen, relax \
**coup en traître**   stab in the back \
**être de mise**  = Qui est conforme à des normes, à des usages habituels dans un contexte ou un environnement particulier. \
**le forage**  drilling \
**pourfendeur**  attacker, opponent \
**des tombereaux de**  *fig.* loads of \
**écharper qn/qch**  to tear sb/sth to pieces \
**avoir la perpète**  to get life \
**les chahuts d’après-match**  noisy disorder after a sports match \
**la congère**  snowdrift \
**fier-à-bras**   braggart \
**dégingandé**  lanky \
**rester au chevet de qn**  to stay at sb's bedside \
**un fichier**  file; filing cabinet \
**se camer**  to be on drugs \
**haler**  to tow [bateau]; to haul in \
**une aire**  sphere / area / eyrie \
**le guêpier**  wasps' nest; (situation difficile) tight corner \
**bouilloner**  to bubble, be lively \
**caser**  to put, stick (dans in); (loger) to put [sb] up; [parents] to marry off ⇨ ils aimeraient bien caser leur fils \
**la tranchée**  *Mil* trench \
**il a eu un éclair de génie**   he had a brainwave \
**par bribes**   bit by bit \
**grimper**  to climb \
**la babiole**  trinket, trifle \
**suinter**  to seep, ooze \
**le village était blotti au pied de la montagne**  the village nestled at the foot of the mountain \
**pincement**  pinch, pang \
**coussinet**  small cushion \
**crécelle**  (instrument, jouet) rattle \
**sapeur (du Génie)**  sapper (a soldier responsible for tasks such as building and repairing roads and bridges, laying and clearing mines, etc.) \
**éblouissement**  dazzling experience / dizzy spell \
**colis piégé**  parcel bomb \
**un embouteillage**  traffic-jam \
**encadrement**  supervision; supervisory staff; (Econ) control \
**relent**  lingering odour, whiff \
**presser l'allure**  (à pied) to quicken one's pace \
**escarcelle**  *archaic* purse \
**retentir**  (résonner) to ring out; (plus fort) to resound; \
**potable**  also: *(passable)* decent \
**sauterie**  *dated* party; hop \
**c'est du pipeau**  it's bogus \
**nombrilisme**  self-absorption, navel-gazing \
**la hausse sera répercutée sur le client**  the increase will be passed on to the customer \
**mettez des gants pour éviter les gerçures**   wear gloves to prevent chapping \
**soufflet**  (de cheminée, appareil photo) bellows; *dated* (gifle) slap \
**un couple bien/mal assorti**  a well-/an ill-matched couple \
**olé olé**  naughty, racy \
**mordicus**  pigheadedly, stubbornly \
**un choix cornélien**  a choice between love and duty \
**pognon**  dough, money \
**légiférer**  to legislate; (*fig.*) to lay down the law \
**moite** muggy, damp; sweaty \
**être taillé pour faire**  to be cut out to do \
**les patenôtres** *dated* prayers \
**un pignon**  gable \
**boucle-la!**  shut your trap! \
**ligoter qn** to truss [sb] up (**avec** with) / *fig.* to bind sb, to tie sb's hand \
**serrer la pince à qn**  *inf.* to shake hands with sb \
**la propagande qu'on nous assène**   the propaganda we are bombarded with \
**bras de fer**  arm wrestling \
**un forçat**  (bagnard) convict / (galérien) galley slave \
**hormis**  *formal* save; except (for) \
**un orteil**  toe \
**rendre son tablier**  to give one's notice \
**goudronner**  to tarmac \
**donner dans le panneau** to fall for it \
**un passeur**  ferryman / smuggler, mule \
**démailloter**  to unswaddle \
**se ruer**   to rush \
**s'éterniser**  inf. to stay for ages, overstay one's welcome
**subreptice**  surreptitious \
**un pauvre hère**  a poor wretch \
**à bon escient**  wittingly, advisedly \
**butiner**  *[abeilles]* to gather pollen from *[fleurs]*; *fig.* to glean, to pick up *[renseignements]* \
**un service public défaillant en matière de santé**  a public service which fails to provide proper health care \
**se moucher**  to blow one's nose \
**magouilles électorales**  electoral fiddling \
**partent en fumée**  to go up in smoke \
**le reste est à l'avenant**   the rest is similar \
**arguant du fait que ...**   pointing to the fact that ... \
**la haute**  upper crust \
**la magouille**  fiddling, trick
**incollable**  (qui a réponse à tout) impossible to catch out \
**sournois**  sly; underhand \
**je n'en démords pas**  *(d'une idée, opinion)* I won't let go of it \
**donne-moi juste un fond de porto**  give me just a drop of port \
**froisser**  to crease, to crumple / to hurt [personne, sensibilité] / to strain [muscle, nerf] \
**le minou**   pussycat / (terme d'affection) mon gros minou = my sweetie \
**muguet**  lily-of-the-valley \
**entraver**  to hinder, impede \
**le boisseau**  bushel \
**mallette**  vanity case; briefcase \
**une bévue**  blunder \
**le carrelage**  tiled floor \
**acculer qn contre qch**  to drive [sb] back against sth \
**un doublon**  doublet \
**la béance**  gap \
**malotru**  boor \
**la vareuse**  jersey / uniform jacket \
**déglinguer qch**  to bust, break sth \
**pâtir de**  to suffer from \
**entraver**  to hinder, impede / to hobble \
**elle est mal en point**  she's not too good; she's in a bad way \
**méthode peu avouable**  rather dubious method \
**moutonner**  *[mer]* to be covered with white horses / *[ciel]* to be full of fleecy clouds \
**recul du dollar**   fall in the dollar \
**un hoquet**  hiccup \
**déjouer**  to frustrate [astuce, précaution]; to foil [plan, conspiration]; to evade [surveillance, contrôle]; \
**décortiquer**  to shell, peel, hull; to dissect [texte, discours] \
**à la rigueur**  if absolutely necessary, in a pinch \
**laisser les choses se décanter**   to allow the dust to settle \
**entasser dans**  to pile into / to pack, cram \
**à la revoyure**  be seeing you  \
**fouler**  to set foot on \
**les minauderies**  affected mannerisms \
**répercuter**  to pass [sth] on \
**s'engueuler avec qn**  to have a row with sb \
**saignée**  bloodletting; [budget] hole (dans in); (entaille) cut; (pour câble) groove \
**prendre douze balles dans la peau**  *inf.* to be shot by a firing squad \
**recevoir une raclée**  to get a hiding \
**se mettre en vrille**   [avion] to go into a tailspin \
**la bobine**  reel, spool / electric coil / *slang* (visage) face \
**pli**  fold, pleat; letter \
**s'engager sur une route/dans un tunnel**   to go into a road/a tunnel \
**en guenilles**  in rags \
**étanche**  (~ à l'eau) waterproof; impenetrable \
**la parure**  finery / set of jewels \
**jouer/tenter son va-tout**  to stake/risk everything \
**de bonne composition**  be good-natured \
**faire basculer une benne**  to tip over a garbage bin \
**joncher**  to litter, to be strewn over [sol, plancher etc] \
**tabler sur**  to bank on \
**millimetré**  precise, organized \
**se faire mousser**  (inf) to sing one's own praises \
**cela va leur mettre du plomb dans la cervelle**  *inf.* that will knock some sense into them \
**haut de gamme**  high-end \
**les fringues**  vieux vêtements \
**il faut boire la coupe jusqu'à la lie**  you have to see it through to the bitter end \
**les contreforts**  foothills \
**prébende**  sinecure \
**assouvir**  to satisfy [faim, désir, curiosité]; to assuage [colère, passion] \
**le pays est au bord du gouffre**   the country is on the brink of the abyss \
**tressaillement (de)**  a quiver (of) \
**le clapotement**  lapping (**de** of) \
**être en proie au doute**   to be prey to doubt, to be beset by doubts \
**hocher la tête**   (de haut en bas) to nod; (de droite à gauche) to shake one's head \
**au point mort**  na mrtvoj točki \
**carrelet**  plaice; fishing cabin \
**cocher les cases**  to tick the boxes \
**courir le cotillon**  *(dated)* to chase after skirts \
**barème d'imposition**   tax schedule or scale \
**perquisition**  (of a house) search \
**je m'en fiche**  I don't give a damn \
**radier**  to debar, suspend \
**le morpion**  tick-tack-toe / brat \
**être bien/mal avisé**  to be well-/ill-advised \
...
**semer qn**  also: to shake off [poursuivant, gêneur]; to leave [sb] behind [concurrent] \
**l'entresol**  mezzanine \
**bourreau de travail**  workaholic \
**nouvelle donne internationale**  new international order \
**le ramdam**  racket, noise / fuss \
**abasourdir**  to deafen; to stun \
**s'éprendre de** to become enamoured of, to fall in love with \
**à terme**  eventually \
**délabrement**  dilapidation, poor state \
**la foudre**  lightning \
**tu as un créneau demain?**  do you have any free time tomorrow? \
**porter plainte contre qn**  to lodge a complaint against sb (auprès de with) \
**serrer la vis à qn**  to tighten the screws on sb \
**gâcher**  to waste; to spoil \
**un tacot**  *(old car)* banger, crate \
**achopper sur**  stumble over \
**la touillette**  coffee-stirrer \
**le sapeur-pompier**  fireman \
**le haut-fond**  shallows \
**cette viande, c'est de la carne**   this meat is leathery \
...
**le foudre**  cask \
**se dresser contre**   to rebel against [injustice] \
**mitoyen**  [cloison, haie] dividing; [arbre] jointly owned; [bâtiment] adjoining \
**faire bouillir la marmite**  to bring home the bacon \
**faucher** to mow, to cut / (piéton) to mow down / *inf.* to pinch, steal   \
**l'animation**  also: organization / coordination: elle a été chargée de l'animation du tournoi/stand \
...
**rouler sur la jante** *inf.* to drive on a flat tyre \
**rouler sur l'or**  to be rolling in it \
**depuis la nuit des temps**  since the dawn of time \
**à l'aune de**  by the yardstick of \
**à leur guise**  just as they wish \
**pan**  section, part / side \
**desserré**  loose \
**hébété**  stupid \
...
**niquer sb**  to lay sb \
**être dans le collimateur**   to have it in for sb \
**le banc de touche**   the substitutes' bench \
...
**subodorer** to detect \
**être à l'affût**  to lie in wait, be on the lookout (**de** for) \
**<u>s'enquérir</u> de la santé de qn**  to inquire or ask after sb \
**le tamis**  sieve \
**non-lieu**  dismissal (of a charge) \
...
**la punaise de lit**  bedbug \
**requinquer qn**  to pep sb up \
**tourelle**  turret \
**se saper**  to dress (up to the nines) \
**s'entretuer**  to kill each other \
**méthode Coué**  autosuggestion \
**récuser**  to challenge, to object to [juré, témoin, arbitre] \
**le gîte et le couvert**  room and board \
**le zinc**  counter, bar \
**la lignée**  descendants, line of descent; tradition \
**rissoler**  *(cooking)* to brown \
**emporte-pièces**  pastry-cutter \
**échauffourée**  brawl, skirmish \
**s'effaroucher de**  to take fright at \
**le leurre**  illusion / lure, decoy \
**l'orpaillage**  panning for gold \
**appelé qn à la rescousse**  to call to sb for help \
**forfait**  (prix global) fixed rate / (séjour) package / (crime) hideous crime \
**une saccade**  jerk \
**faire une queue de poisson à qn**  *Car* to cut in front of sb \
**mener une tâche à bien**   to see a job through \
**le loup de mer**  sea bass \
**se reporter sur**   [affection] to be transferred (**sur** to); [voix] to be transferred (**sur** to) \
**la voilure**  (ensemble des voiles) sails \
**un ovni**  UFO \
**piaffer**  *[cheval]* to paw the ground / to be impatient (**de faire** to do) \
**river**  to rivet, fasten \
**un remblai**  embankment \
**soupente**  loft, garret; cupboard under the stairs \
**avoir des courbatures**   to be stiff \
**fricoter**  to cook up *[plat]* \
**glycine**  wisteria \
**meubler**  to furnish; *fig.* (remplir) to fill [solitude, silence] ⇨ dire des banalités pour meubler la conversation \
**le chapelet**  rosary \
**colin**  hake \
**se rincer la dalle**  *slang* to have a drink
**il a pris un mauvais pli**  he's got into a bad habit \
**entrepôt**  warehouse; stockroom \
**un enfoiré**  asshole \
**avoir des lubies**   to have whims \
**un bibelot**  ornament \
**se braquer contre qn**  to turn against sb \
**frileux**  sensitive to the cold / cautious \
**faner**  to wither, wilt \
**prévaloir sur qch**  prevail over \
**la chapelure**  breadcrumbs \
**ringard**  dated \
**se faufiler à l'intérieur**  to worm one's way in \
**le détroit**  straits \
**bourré**  packed, bulging (de with); slang (ivre) sloshed \
**abreuver qn de qch**  to bombard sb with sth \
**plein d'embûches**   hazardous, fraught with pitfalls \
**larguer les amarres**  *lit.* to cast off / *fig.* to set off
**une baliverne**  nonsense \
**la vigie**  lookout, lookout post \
**chien renifleur**  sniffer dog \
**les soldats déferlèrent sur la ville**   the soldiers poured into the city \
**passible de impôt**  taxable \
**palabre**  endless discussion \
**facile à déceler**  easily detectable, easy to detect \
**pondre**  intr. to lay *[un œuf]*; *inf.* to produce, churn out \
**être recalé à une épreuve**  to fail a test \
**le branle-bas**  commotion \
**la veillée funèbre**   wake \
**prodiguer (à)**  to lavish [attentions, affection, soins, compliments] (on) / to make lots of *[promesses]* (to) / to give lots of *[conseils, encouragements]* (to) \
**allégement fiscal**   tax relief \
**hormis**  save, except for \
**véreux**  wormy / crooked, dodgy \
**quelle mouche les a piqués?**  what's got into them? \
**un truand**  gangster, mobster / crook \
**banon**  cheese, wrapped in chestnut leaves \
**s'affaisser**  s'effondrer \
**terne**  dull, lifeless; drab \
**pâlichon**  pale from illness or fatigue / watery \
**être pété**  (soûl) to be pissed; (drogué) to be high \
**branleur**  lazy sod, bum \
**le postiche** hairpiece; toupee; wig; false moustache \
**racler**  to scrape [sth] clean, scrape off \
**le rouget**  red mullet \
**le calmar**  squid \
**un porcelet**  piglet \
**élagueur** pruner / (outil) pruning hook \
**dépouiller les bulletins**  to count the votes \
**l'hurluberlu**  oddball \
**une moue de dégoût**  a disgusted pout \
**le lacet**  (shoe-)lace / hairpin turn \
**rouler qn dans la farine**  (inf) to pull a fast one on sb informal \
**un pillard**  looter \
**trousse à couture**  sewing kit \
**se la couler douce**   *inf.* to take it easy \
**à la sauvette**  in a rush, hastily; on the sly \
**échappée de beau temps**  a spell of good weather
**déboires**   disappointments; difficulties; setbacks  \
**boire tout son soûl**  drink one's fill, as much as one wants \
**pilotis**   | pilɔti | nm.pl stilts \
**de justesse**  only just \
**postuler**  to apply for *[emploi]* (**auprès de** to) \
**huissier**  bailiff; porter, usher \
**s'entraîner au tir**  to practise shooting \
**comme quoi!**  which just shows! \
**attendre la remise des clés**  Schlüsselübergabe \
**la bagnole**  car \
**mou, mol, molle**  soft, limp, flabby \
**se faire avoir jusqu'au trognon**   to be well and truly had \
**avertisseur**  (général) alarm; (car) horn \
**ravaler**  to clean, renovate; *fig.* to give sth a facelift; to swallow \
**défaillant**  faulty, failing; inefficient \
**errer**  to wander, roam \
**allure**  pace, speed; appearance, look \
**se jouer de**  to make light of *[difficulté]* / to defy *[gravité]* / to make light work of *[obstacle]* \
**jante**  rim; (roue sans pneu) wheel \
**Bérurier** = Meilleur ami du commissaire Antoine San-Antonio \
**être sur la sellette**  to be in the hot seat \
**faire un carton**  to do great \
**c'est assommant de faire la vaisselle**  it's a real drag doing the dishes \
**violon d'Ingres**   hobby \
**dé (à coudre)**  thimble \
**un désaveu**  denial / rejection \
**pied-de-poule**  houndstooth \
**eaux grises**  = eaux usées domestiques faiblement polluées \
...
**le camelot** street vendor \
**amocher**  to bash [sb/sth] up \
**au ras de la terre**  lit. at ground level \
**chemin creux**  sunken lane, hollow way \
**priser**  to hold [sth] in esteem, prize; to snort [drogue] \
**je ne vais pas faire de vieux os ici**   I'm not going to hang around here forever \
**la trame**  weft, woof; (d'histoire, de spectacle) framework; (de vie) fabric \
**la fourche**  pitchfork \
**gaz à effet de serre**  greenhouse gas \
**la maladresse**  clumsiness \
**combler**  to fill in \
**épandage de fumier**  manure spreading, manuring \
**veston**  (man's) jacket \
**par méprise**   by mistake \
**le dedans** inside \
**décapage** cleaning / stripping / scrubbing \
**à tout-va**  sans limitation, de manière imprudente \
**ternir**  to tarnish \
**régalien**  kingly \
**une ornière**  rut \
**boucher les oreilles** to plug one's ears \
**fioul domestique**  heating oil (=**   feul**) \
**pouêt-pouêt**  honk-honk \
**coup de foudre**   love at first sight \
**clébard, clebs**  mutt, dog \
**match en différé**  recording of the match \
**le manche**  handle; knuckle; clumsy idiot \
**l a un baratin avec les femmes!**  he's great at chatting up the girls \
**caracoler** en tête  to be well in the lead \
**le pissenlit**  dandelion \
**la marqueterie**  inlay \
**la brûlure**  burn; mark \
**le cambouis**  dirty grease \
**terreau**  compost \
**émoustillant**  titillating \
**ébahir**  to dumbfound, to astound \
**il est vache avec elle**   \
**sous pavillon américain**  under the American flag (naut) \
**un plateau**  tray (**de** of) / *Theatre* stage / *Cinema, Television* set / (de balance) pan / (de table) top \
**il est grand temps**  it's high time (de faire to d  o) \
**avoir un coup de mou**  *inf.* to have a dip in energy \
**un aiguillon**  sting / incentive / thorn \
**à 10 heures et demie pile**  at ten-thirty sharp \
**Maison Lameloise**  3* in Burgundy \
**le cerne**  ring, tree ring \
**hautain**  haughty \
**le héraut**  harbinger; herald \
**une dinde**  also: *inf.* silly goose \
**payer rubis sur l'ongle**  to pay cash on the nail \
**faire la nouba**  to live it up \
**la prime**  bonus / subsidy \
**se rincer la bouche**  to rinse one's mouth out
**bouc émissaire**   scapegoat \
**une tournée**  also: *(au café)* round / *slang* beating \
**mesures de relance**   reflationary measures \
**entamer**  to start, begin \
**la ciboulette**  chive \
**la cloison**  partition, screen \
**onéreux**  onerous; expensive \
**coquin**  naughty, saucy \
**craquer**  also: [entreprise] to collapse; [personne] (de tension nerveuse) to break down, to crack up  \
**rester pantois**  to be flabbergasted, 'ostati paf' \
**un produit dont le succès ne s'est jamais démenti**  an unfailingly successful product \
**bondir**  to leap; to react furiously, to hit the roof; to soar \
**zouave**  clown, comedian \
**en pagaille**  = en désordre \
**le maillon**  link \
**ils ont beau jeu de me critiquer**   it's easy for them to criticize me \
**courir le jupon**   to womanize \
**supputer que**  to calculate, to work out that \
**vacataire**  temporary employee \
**CDD**  contrat à durée déterminée \
**le horion**  *dated* blow \
**silloner les rues**  to go up and down, criss-cross \
**un emplâtre**  medicated plaster / *inf.* (personne) good-for-nothing \
**la mue**  (zoo.) metamorphosis, sloughing; (fig) transformation \
**le shit**  dope, pot \
**avoir une sensibilité à fleur de peau**   to be hypersensitive \
**production à la chaîne**   mass production \
**faire main basse sur**  to help oneself to *[biens]* / to take over *[marché, pays]* \
**s'étirer**  to stretch \
**un aléa**  vagary; hazard \
**la tente de camping**  tent \
**froisser l'amour-propre de qn**  to hurt sb's pride    \
**chemin de ronde**   path round the battlements \
**dépouilles**   (butin) spoils; \
**décommander un rendez-vous**  to cancel an appointment \
**se fourrer une idée dans la tête**   to get an idea into one's head \
**un fana de cinématographie**  a film buff, a film fanatic \
**un débardeur**  tank-top, sleeveless tee-shirt \
**s'embêter pour**, to worry about ⇨ *ne t'embête pas pour si peu* \
**corps-à-corps**  hand-to-hand combat \
**battre à coups de trique**  to cudgel \
**le timonier**  helmsman \
**glaive** double-edged sword \
**s'embêter**  to get bored;  \
**il était moins une**  it was a close shave \
**vidanges**  pl. sewage \
**se gargariser de**  to revel in \
**sauter qqn**  to screw sb \
**saumâtre**  brackish \
**épeler**  to spell \
...
**mise au point**  focus \
**marigot**  marshland \
**la lie de vin**   wine dregs or lees \
**ça me démange de faire**  I'm itching to do \
**moniteur de natation**  swimming instructor \
**le chinois**  conical strainer \
**épars**  scattered \
**harnachement**  *(de cheval)* harness / *inf.* *(de personne)* get-up   \
**bidouiller une horloge**  to fiddle with, tinker with a clock \
**les bras ballants**  his arms dangling \
**creuset**  crucible, melting pot \
**le roseau**  reed \
**que dalle**   *slang* nothing at all; damn all \
**le chaume**  stubble, stubble field; thatch \
**une ortie**  nettle \
**un drôle de pistolet**  (fig, dated) an odd customer \
**déraper**  to get out of control; to slip, skid \
**la pinède**  pine forest \
**flambant neuf**  brand new \
**jardin d'enfants**  kindergarten \
**bon enfant**  good-natured \
**la bruyère**  heather, briar; heath \
**se sentir acculé**  to feel cornered \
**dévisager qn**  to stare at \
**la masure**  hovel \
**rouler une pelle à qn**  to French kiss sb \
**la gnôle**  hooch, spirits \
**pays fournisseur**  exporting country \
**blaser**  to make [sb] blasé \
**se leurrer**  to delude oneself (de with, au sujet de about) \
**manquer de jugeote**  to have no common sense \
**se démerder**  (se débrouiller) to manage \
**crapaud**  toad \
**ébouriffer**  to tousle, ruffle \
**avoir le sang chaud**  to be hot-headed \
**fruste**  uncouth, crude / worn \
**corneille**  crow \
**un quartier huppé**   upper-crust neighborhood \
**la bauge**  (de sanglier) wallow / fig. (lieu sale) pigsty \
**limer**  to file, file down (nails etc) \
**une racaille**  scum \
**Durandal**  the sword of Roland \
**satané**  damned \
**galeux**  scabby, mangy \
**passer qch à l'étamine**  to pass sth through muslin \
**char (de combat)**  tank \
**dorloter**  to pamper \
**tomber dans les oubliettes**  to be forgotten \
**au mitan de**  (dated) in the middle \
**le passe-temps**  pastime, hobby \
**une guêpe**  wasp \
**bosser**  to work, cram \
**assommer**  to knock [sb] senseless; *inf.* to bore [sb] to tears; *inf.* [nouvelle] to stagger, overwhelm \
**prenant**  fascinating, captivating \
**homme à poigne**  strong man \
**se démerder pour obtenir qch**  to wangle sth \
**la crevasse**  crevasse; crack, fissure \
**calumet de la paix**  peace pipe \
**se mettre au diapason de**  to fall in step with \
**chétif**  puny, undeveloped \
**un amas**  |ama| pile, heap / [Astr.] cluster \
**frêle**  frail, weak \
**être bien roulée**  *[femme]* to be a nice piece \
**feu la reine**  late queen \
**replet**  plump, chubby \
**mort de chez mort**  100% dead \
**le ragot**  malicious gossip \
**être à cran**  to be edgy or on edge \
**le terre-plein**  platform / (de route) median strip / (de rond-point) central island \
**ras-la-touffe**  Se dit d'un vêtement féminin très court \
**l'économat**  bursar's office \
**chanceler dans ses opinions**  to waver in his opinions \
**le gourdin**  bludgeon, cudgel \
**corps et biens**  (Nautical) with all hands \
**la béquille**  crutch \
**se jeter dans la gueule du loup**  to stick one's head in the lion's mouth \
**un effectif de 200 élèves**  200 pupils on the roll  \
**la rampe**  banister; *Theatre* the footlights \
**ineptie**  inanity \
**surchauffe**  overheating \
**la coupe de la robe met sa taille en valeur**  the cut of the dress shows off her slim waist
**la hausse sera répercutée sur le client**  the increase will be passed on to the customer \
**petit bois**  kindling \
**cadenas**  | kadna | padlock \
**strier** to streak (de with); to make grooves in \
**se déglinguer la santé** to wreck one's health/liver \
**narguer**  to taunt; to flout \
**épuisette**  Petit filet de pêche \
**se prendre les pieds dans le tapis**  to trip / fig. se tromper dans la réalisation d’une tâche compliquée
**émoussеr**  to blunt, dull \
**en avoir plein les mirettes**  to be dazzled \
**résilier**  to terminate [contrat, bail] \
**matraquer**  to club, hammer sb; to bombard [media] \
**engueuler qn**  to tell [sb] off [enfant]; to give [sb] an earful \
**décrotter**  to scrape the dirt off; *inf.* to civilise \
**grief**   grievance  \
**une écharpe**  nf. scarf \
**meunier**  miller \
**naguère**  quite recently; formerly \
**nanardesque**  Qui est de piètre qualité, en parlant d'un film. \
**vaquer à ses affaires**  to attend to one's business \
**elle est dans les parages**  she is around somewhere \
**escompter que...**  to expect or anticipate that...
**piaffer d'impatience**   to be champing at the bit \
**le dérapage**  skid, skipping / blunder / escalation / loss of control \
**l'amidon**   starch \
**route en remblai**  causeway \
**prendre le fou rire**  to have a fit of the giggles \
**s'embourber**  to get stuck in the mud; to get bogged down in (**dans**) \
**se faire du tracas pour qn/qch**   to worry about sb/sth \
**faire du gribouillage**  to doodle \
**rébarbatif**  [travail, activité] offputting / [visage, apparence] forbidding \
**rabattre le caquet à qn**  *inf.* to put sb in his/her place \
**ramassé**  stocky, squat / huddled up; crouched, crouching / *[style, expression]* concise, condensed \
**avoir la dalle en pente**   to be a boozer \
**écraser**  crush, squash \
**fente**  slit, crack; (slang) vulva \
**cuver**  intr. to ferment; to sleep it off \
**procès-verbal**  minutes; *criticised* fine \
**une combine**  trick, wheeze \
**vélo tout terrain, VTT**  mountain bike \
**rature**  crossing-out, deletion \
**il faudrait quelqu'un de votre trempe**  we need someone of your calibre  \
**quolibet**  jibe \
**un marcel**  sleeveless t-shirt, tank top \
**neuneu**  silly \
**un quêteur**  Spendensammler \
**la vis**   |vis| screw \
**donner un blanc-seing à qn**  to give carte blanche to sb \
**atrabilaire**  bad-tempered; atrabilious \
**grogne**  discontent \
**un va-nu-pied**  tramp; bum \
**sitôt après**  immediately after, soon after \
**tomber d'accord**   to come to an agreement \
**si vous y tenez**  if you insist \
**braver**  to defy, brave [personne, ordre, tabou] \
**il y a anguille sous roche**  there's something going on \
**se calfeutrer chez soi**   to shut oneself away \
**résipiscence**  repentance \
**commanditer qch**  to support, finance, sponsort sth \
**s'attabler**   to sit down at the table ▸ être attablé \
**morveux**  adj. snotty-nosed \
**être rivé à qch**   to be tied to [travail, famille]; to be glued to [télévision] \
**et tout le bataclan**  and all the rest of it \
**entretien**  upkeep, maintenance, care; cleaning; discussion, interview \
**en rechignant**   grudgingly, with a bad grace \
**une flopée de gamins/livres**  a whole load of kids/books \
**flairer**  to sniff, scent; (fig) to sniff out \
**alangui**  languid \
**elle n'a rien dans le coco**   she isn't all there  \
**funambule**  tightrope walker \
**établi**  workbench \
**un commercial**  sales and marketing person \
**désapprendre**  to forget (**à faire** how to do); to unlearn \
**la randonnée m'a fourbu**  the hike has exhausted me \
**blanc-seing**  carte-blanche \
**la bourgade** small town \
**un manouche**  gypsy \
**piocher dans**  to dip into [économies, fonds] / to dig into [tas, porte-monnaie] \
**un soiffard**  boozer \
**la défonce**  drug abuse \
**au détour de la conversation**   fig. in the course of the conversation
**la trogne**  mug, face \
**jouer les filles de l'air**  *inf.* to vanish into thin air \
**régler une ardoise**  to settle a debt \
**à mauvais escient**   [agir, parler] ill-advisedly \
**grapiller**  to eat sth \
**animal prisé pour sa fourrure**   animal prized for its fur \
**fourberie**  deceitfulness / (acte) deceit \
**chiper**  to pinch, nick \
**un dessous-de-table**  under-the-counter payment, bribe \
**le grenouillage**  shady manoeuvres, machinations \
**pile**  exactly \
**étal**  stall \
**attiser**  to kindle [feu, convoitises]; to fuel [discorde]; to stir up \
**être Gros-Jean comme devant**  Ne pas être plus avancé. \
**la crosse**  (de fusil) butt, (de revolver) grip / Religion crozier / Sport stick \
**croque-mitaine**  bogeyman, ogre \
**l'acharnement**  furious energy / tenacity, determination \
**bon vent!**  *inf.* good riddance! \
**pimpant**  *[femme, robe, biciclette]* spruce, smart \
**un interrupteur**  switch \
**à califourchon**  astride \
**à dessein**   deliberately, by design \
**canevas**  canvas / tapestry \
**fou furieux**  hopping mad \
**éclopé**  injured \
**on m'a fauché mon vélo**  my bike's been pinched \
**à contrecœur**   grudgingly, reluctantly \
**Je raffole de la glace aux pistaches.**  I'm crazy about pistaccio icecream. \
**un grand brûlé**   a third degree burns victim \
**avisé**   sensible \
**pianoter**  to tinkle, tap \
**raz-de-marée**  tidal wave    \
**le discours sera diffusé en différé**  the broadcast of the speech will be a recording \
**parano**  paranoid \
**ravaler ses larmes**  to hold back one's tears \
**courir à sa (propre) perte**  to be on the road to ruin \
**il a frôlé la mort**  he had a brush with death \
**fillette fillette ce que tu te goures**   J Greco \
**presse de charme**  pornographic press \
...
**gueux**  |gø| beggar; rogue \
**une fusée air-air**  air-to-air missile \
**intérimaire**  interim \
**acter**  to take note of \
...
**le perron**  flight of steps (outside), stoop \
**une tenancière de maison close**  madam \
**garder les arrêts** to be under arrest \
**en avoir par-dessus la tête**   to be fed up to the back teeth informal (**de** with) \
**mettre des bâtons dans les roues de qn** Multiplier les obstacles afin qu'un projet ne puisse se réaliser. \
**effilocher** to shred \
**envoi**  act of sending something, something sent; dedication (in a manuscript) \
**tiraillements d'estomac**  hunger pangs \
**renouer avec**  to make up with [personne]; (après perte de contact) to get back in touch with [personne]; to revive [tradition] \
**broute-minou**  carpet munching \
**un patelin**  small village \
**colonie de vacances**  summer camp \
**guigner**  to have one's eye on *[place, héritage]* / *inf.* to eye, to glance at *[personne, chose]* \
**l'ensevelissement**  burial \
**aller or marcher comme sur des roulettes**  to go smoothly \
**bougre**  bloke \
**une passade**  fad / brief affair \
**les délaissés**   those abandoned, those left behind \
**s'effilocher**   to fray / *[confiance, amour]* to dwindle (away) / *[relation]* to fizzle out \
**équipée**  escapade, sortie \
**dorénavant**  from now on; thenceforth \
**se dépatouiller**  = se débrouiller ⇨ qu'il se dépatouille tout seul \
**ça m'a mis la puce à l'oreille**  that set me thinking \
**la tronche**  mug; face \
**relou**  (verlan pour lourd) serious, annoying, unsubtle \
**moins-disant**  lowest bidder \
**mirobolant**  fabulous \
**je ne peux plus (y) tenir**  I can't stand it any longer \
**faire la grasse matinée**  to have a lie in \
**étriller**  to curry [cheval]; *fig.* (critiquer) to tear to pieces; Sport to thrash; *fig.* to overcharge, fleece \
**pourtour**  perimeter, circumference; surrounding area \
**fardeau**  burden \
**étouffer**  to stifle, suppress; to hush up \
**canapé**  sofa, settee \
**égaré**  lost, stray / wild, disturbed \
**renifler**  to sniff \
**un ponte**   *[personne]* big shot \
**à l'encontre de**  contrary to, counter to \
**la baie**  bay / berry \
**colza**  rape \
**avaler des couleuvres**  Kröten schlucken müssen \
**déconvenue**  disappointment \
**craquer**  to split, rip, crack; to creak; to collapse, break down \
**effarer**  to alarm \
**un hâbleur**  boaster \
**se railler de**  to make fun of \
**mainmise sur**  control over \
**faire fissa**  to get a move on \
**enduit de rebouchage**  spackle \
**allégement** lightening; (de dette, charges) reduction; (de contrôles) relaxing \
**éplucher** lit to peel *[fruit, légume]*; *fig.* to go through [sth] with a fine-tooth comb *[article, comptes]* \
**à fleur de peau**  on the edge, raw, very sensitive  \
**prestance**  presence, bearing \
**tanguer**  [navire, avion] to pitch; [personne] to be unsteady on one's feet \
**poignant** poignant; (déchirant) heart-rending, harrowing \
**jazzer**  to jazz up \
**monter au créneau**   to intervene \
**happer**  to catch, seize \
**le battage du blé/beurre**  wheat threshing/butter churning \
**basket** | baskɛt | (sport) basketball; (chaussure de sport) trainer \
**ramasser une pelle**  to fall flat on one's face \
**différer**  tr. to postpone \
**tignasse**  dérogatoire. mop of hair \
**flûte!**  damn! \
**agrafer**  to fasten [vêtement] / to staple (together) [papiers, tissu] / (slang) to nab, catch \
**à fond la caisse**  informal [partir, s'en aller] at breakneck speed; [mettre la musique] at full blast \
**un landerneau**  small-minded community where everyone knows everyone else's business \
**craie**  chalk \
**un créneau publicitaire**  *Radio, Television* advertising slot \
**à coup sûr**  definitely, for sure \
**dans la foulée d'un événement**  in the aftermath of an event \
**déclencher le tir**  to open fire \
**la Toussaint**  All Saints' Day \
**se faire un balayage**  to have highlights put in \
**l'aneth**  dill \
**avoir le feu au cul**   to be horny \
**leste**  agile, nimble \
**écœurer**  [nourriture, odeur] to make [sb] feel sick \
**le pus**  |py| pus \
**le gibier foisonne dans le parc**  the estate is teeming with game \
**la cuisson**  cooking \
**il fricote avec sa voisine**  he's got something going with his neighbour \
**manquer de disparaître**  to almost disappear \
**déontologie**   professional ethics \
**en boucle**  in continuous loop \
**marmotte**  marmot; sleepyhead \
**mettre à qn le pied à l'étrier**  to get sb started \
**une empreinte**  footprint, track / impression, imprint \
**pince-sans-rire**  deadpan \
**girovague**  Moine errant, attaché à aucun monastère \
**le pince-fesses**   bash; cocktail-party \
**le cartable**  schoolbag, satchel; briefcase \
**peu décoiffant**  uninspiring \
**tergiverser**  to dither; to shilly-shally \
**le matos**  |matos| equipment, gear / kit \
**la vie au grand air**  outdoor life \
**note interne**  memorandum \
**sous ce chef**  under this heading \
**la rate**  spleen \
**chauffard**  reckless driver; road hog \
**une maison recouverte de chaume**  a thatched cottage \
**prendre les devants**   to take the initiative \
**être friand de qch**   to be very fond of sth \
**graphiques en tuyaux d'orgue**  bar chart \
**donner un coup de canif dans le contrat**  *inf.* to be unfaithful \
**la fusée**  rocket; missile \
**secret de Polichinelle**  secret supposé, en fait connu de tous \
**la rotule**  kneecap; patella \
**velum**  canopy, awning \
**le tableau est accroché de traviole**  the picture is hung crooked \
**en mettre un coup**  *inf.* to give it all one's got \
**VTC** = Voitures de Transport avec Chauffeur \
**gâteux**  senile \
**va-et-vient**  comings and goings, toing and froing \
**c'est d'une évidence**  it's so obvious \
**avoir de l'oseille**  to be rolling in it  \
**s'époumoner**  to shout/sing oneself hoarse \
**un goulet**  (de port) narrows / (en montagne) gully \
**sabord**  scuttle = Ouverture dans un navire pour donner passage à la bouche des canons, à des conduits d'aération.  \
**colis**  parcel \
**les haut-le-cœur**  nm.pl. retching, gagging \
**avertisseur d'incendie**  fire alarm \
**se faire gronder par qn**   to get told off by sb \
**le détroit de Gibraltar**   the Straits of Gibraltar \
**un raccourci**  shortcut / summary / foreshortening \
**nanard**  old man; anarchist \
**s'endormir en dodelinant de la tête**   to nod off \
**un arrière-ban**  round of applause \
**chalumeau**  blowtorch \
**bariolé**  multicoloured; gaudy \
**galérer**  1\. to have a hard time (**pour faire** doing); 2. *inf.* to slave away; to slog away \
**la lavallière**  floppy necktie \
**l'essieu**  axle \
**priser du tabac**  to take snuff \
**raz-de-marée**  tidal wave \
**à tout bout de champ**  at every turn \
**tortiller**  to twist; to wiggle \
**le cramé**  burning smell \
**bosser**  to work hard \
**faire dodo**  [child language] to sleep \
**le mulet**  (male) mule \
**se caser**  to tie the knot; to get married; \
**la jauge**  gauge; capacity, tonnage \
**raboter**  to plane; to scrape \
**viol en réunion**  gang-rape \
**le givre**  frost \
**à poil**  stark naked \
**la chenille**  caterpillar \
**aller au feu**  to go into action \
**se défoncer**  to get high \
**s'embêter**  to get bored / to worry (**pour** about) \
**tirer qn du pétrin**  to get sb out of a fix \
**ondoyer**  to baptize \
**le molosse**  huge dog \
**en levrette**  doggy fashion \
**suie**  soot \
**ringard**  dated, behind the times \
**se tasser**  *(avec l'âge)* to shrink / to make oneself look smaller / *[personnes]* to squash up, to squeeze up \
**agrément**  approval; agreement; pleasure, charm \
**haut débit**   broadband \
**ça m'a laissé <u>pantois</u>**  I was flabbergasted \
**les gravats**  m.pl. rubble \
**le bouche-à-oreille**  word of mouth \
**le coquin**  scoundrel, rascal \
**la bourbe**  silt, mud \
**bagnard**  convict \
**il se peut** it may be that, it can be... \
**nichon**  boob, breast \
**San-Antonio**  = une série de romans policiers rédigés par Frédéric Dard \
**pousser des cris d'orfraie**   to scream blue murder \
**jus d'orange avec des glaçons**  orange juice with ice \
**bichonner**  to pamper; to dress [sb] up; to doll up \
**l'ivraie**  rye-grass \
**soupeser**  to heft, to feel the weight of / *fig.* to weigh up *[arguments]* \
**torchon**  cloth, tea towel; (derog) [journal] rag, messy piece of work \
**calfeutrer**  to stop up, to seal _[fissure]_; to draught proof \
**giron**  lap / (fig) bosom \
**le voiturier** valet; valet-parking \
**un boudeur**  sulker \
**dévaler les escaliers**  to rush downstairs \
**pleurote**  (mushroom) pleurotis \
**toubib**  fam. doctor \
**atterré**  appalled, shocked \
**sabre au clair**    with sword(s) drawn \
**la vessie**  bladder \
**se mettre d'accord**   to come to an agreement \
**nicher**  to nest; fam. = loger ⇨ Il niche chez elle. \
**un antre**  den, lair \
**se faire niquer**  to get laid \
**lit gigogne**  hideaway bed \
**balader**  to go for a walk, stroll \
**cadreur**  cameraman \
**les enfants ont dévalisé le garde-manger**  the children have raided the larder \
**figatellu**  une saucisse sèche corse, composée principalement de viande et de foie de porc \
**le cornichon**  gherkin; idiot, nitwit \
**garnement**  brat \
**railler**  to make fun of \
**supputer ses chances de réussite**  to weigh up one's chances of success \
**griffer**  to scratch \
**la fronde**  sling, catapult; rebellion \
**dessin *vs.* dessein**   drawing, design, outline vs. (projet) design; (intention) intention \
**pour (des motifs de) convenance personnelle**  for personal reasons \
**être sous la férule de qn**  to be under sb's iron rule \
**embellie**  bright spell, upturn \
**faire des grumeaux**  [sauce, mélange] to go lumpy \
**essor**  development; (de mode, tendance, sport) increasing popularity \
**un coup tordu**  an underhand trick \
**manquer de recul**   to be incapable of being objective \
**tant/loin s'en faut**   far from it \
**il est mort foudroyé**   he was struck dead by lightning \
**avoir une bonne tapette**   (être bavard) to be a chatterbox  \
**avoir une <u>algarade</u> avec qqn**  to quarrel with sb \
**comment donc!**  but of course! \
**voguer**  = naviguer \
**la plèvre**  pleura \
**la paillote**  grass hut \
**il faut que je me taille**  I've gotta go \
**bail emphytéotique**   long lease \
**ferrailler contre qn**  to clash swords with sb
**oui-da**  yes indeed \
**faire la teuf**  to party \
**faire quelques emplettes**   to make a few purchases \
**le froc**  *slang* trousers / *Religion* habit \
**Bisounours**  carebear \
**embrigader qn**  to recruit (**dans** into, **comme** as) \
**une cocotte-minute**  pressure cooker \
**la pelle**  shovel, spade; [boulanger] peel \
**attirer avec un <u>appât</u>**  to lure with bait \
**nom à rallonge(s)**   double-barrelled name \
**être chahuté**  [monnaie, valeur] to come under pressure; [gouvernement] to be given a hard time    \
**la rechute**  relapse \
**être de guingois**  *[meuble, maison]* to be lopsided \
**remuant**  rowdy, energetic \
**le démêlé**  wrangle \
**raser les murs**  to hug the walls \
**l'aumônier**  chaplain \
**charbonner**  to blacken, go black \
**se damner pour qch**  to sell one's soul for sb/sth \
**une coiffeuse**  also: dressing table \
**le prêche**  sermon \
**coup d'éclat**  a great deed \
**subodorer quelque chose de louche**  to smell a rat \
**prendre la tangente**  to make oneself scarce \
**le pilori**  stocks ⇨ être condamné au pilori \
**tout va à la débandade**   everything's falling apart \
**ébouriffant**  outrageous; incredible \
**l'écriteau**  sign \
**bafouer**  to scorn \
**ici ou ailleurs, ça m'est égal**  here or somewhere else, it's all the same to me \
**la pie**  magpie \
**grever**  to be a burden on \
**capter**  to capture, collect \
**ça fait un bail qu'on ne s'est pas vus!**  we haven't seen each other for ages! \
**gageure**  challenge \
**bafouiller**  to mumble \
**un étau**  vise / *fig.* stranglehold (**autour de** on) \
**acéré**  sharp; cutting, scathing \
**la bavette**  bib / (viande) flank \
**il était moins cinq**  it was a close shave \
**un pot de colle**  lit. pot of glue; *fig.* Personne dont il semble impossible de se débarrasser \
**appel d'air**  draft \
**une aubade**  serenade; (little) concert in sb's honour \
**tanguer**  *[navire, avion]* to pitch; *[personne]* to be unsteady on one's feet \
**la hantise**  dread (cf. honte!) \
**couler un navire**  to sink a boat \
**un gradé**  noncommissioned officer \
**accroc**  | akʀo | tear, breach \
**écorchure**  *[injury]* graze \
**sans-faute**  clear round; faultless performance \
**être en vigie**   to be on watch \
**choyer**  to pamper \
**un forban**  (pirate) pirate / *fig.* rogue \
**barigoule**  stuffed artichoke dish, SW France \
**la cueillette des pommes**   apple-picking \
**le matou**  tomcat \
**se péter la gueule**  to get drunk, wasted / to fall over \
**sans rechigner**  without grumbling \
**déteindre**  to fade; [couleur] to run \
**en aval**  downstream \
**d'entretien facile**  low-maintenance \
**le parpaing**  cinder-block \
**empailler**  to stuff (animal) \
**taillis**  | taji | (broussailles) undergrowth uncountable; (sous-bois) coppice \
**enroué**   hoarse, husky \
**grouiller de**   to be swarming with \
**la pelouse**  lawn / *[Sport]* pitch, field \
**se déglinguer**  *[mécanisme]* to go wrong / *[appareil, machine]* to go on the blink \
**s'occuper d'un problème à bras-le-corps**  to tackle a problem head-on \
**l'effectif**  number of students, enrollment / workforce / (d'une armée) strength \
**la natte**  plait, braid; (sur le sol) mat \
**la fourrure**  fur / Zool. coat \
**les frontières entre la gauche et la droite <u>s’amenuisent</u>**  the differences dwindle \
**avoir des tressaillements**  to quiver (**de** with) \
**moule à gaufre** waffle iron; *inf.* nitwit \
**se sortir de qch sans une égratignure**  to come out of sth without a scratch \
**mettre à mal qch**  to damage sth \
**être hors course**   *Sport, figurative* to be out of the race \
**le boutre**  un type de voilier arabe
**la moquette**  wall-to-wall carpet \
**prunelle**  sloe; (Anat) pupil \
**la manche**  sleeve; (sport) round \
**déflagration**  detonation \
**un sureau**  elder (tree) \
**la maquerelle**  slang (dans une maison close) madam \
**hypocentre**  ground zero \
**le détricotage**  unravelling \
**mention assez bien** pass with 50-60% \
**peu ou prou** more or less \
**se braquer sur** to be pointed at, trained on; to focus on \
**moisi**  moldy \
**c'est de la camelote cette montre!**  this watch is junk \
**piétinement**  the sound of feet, shuffling \
**remballer qch**  to pack sth again, rewrap
**le reître**  thuggish soldier \
**assombrir**  to make [sth] dark, to darken; *fig.* to cast a shadow over \
**dans quel guêpier es-tu allé te fourrer?**  what kind of mess have you got yourself into? \
**sourcilleux**  (exigeant) punctilious; [hautain] supercilious \
**virer**  to fire, sack \
**battre qn comme plâtre**   inf. to beat the living daylights out of sb \
**décrispation**   easing of tension \
**mettre qch en valeur**  to emphasize, highlight / to set off
**la paillette**  sequin, glitter \
**défaire qn de**   to deliver sb from, to free sb from \
**un gratte-papier**  pen-pusher \
**cambrioler** to burgle \
**le moût**  must; wort \
**penderie**  wardrobe; walk-in closet \
**bombé**  domed / rounded / convex / bulging \
**déconvenue**  disappointment \
**jeté l'éponge** to throw in the towel  \
**rechigner à qch/à faire**  to balk at sth/at doing \
**la pancarte**  notice, sign; (manif) placard \
**quadragénaire**    in one's forties \
**étriqué**  cramped; restricted \
**les tares d'une société**  the defects of society \
**le soubassement**  (de bâtiment) base, base course / (Geol) bedrock \
**être habilité à faire**  to be authorized to do \
**faufiler**  to baste \
**bougre d'imbécile**  you bloody idiot \
**hoqueter**  to hiccup; [moteur] to sputter \
**la ronce**  bramble; (nœud du bois) burr \
**faire déchanter**  to disappoint \
**s'émouvoir de**  = s'inquiéter de \
**assorti**  matching; [chocolats, bonbons] assorted \
**une saynète**  playlet \
**avoir de la trempe**  to be made of stern stuff \
**un bourrelet**  roll (of fat) \
**en liesse**   jubilant \
**passage clouté**  pedestrian crossing \
**tenir (bon)**  to hold out \
**se recroquiller**  to huddle up / to shrivel up \
**rut**  | ʀyt | rutting season \
**une voix de crécelle**   a shrill voice \
**à la bonne heure!**   well done! \
**la gomina**  hair cream \
**jeter un pavé dans la mare**  Faire une déclaration qui ébranle, dérange, choque tout le monde \
**avaliser**  to back, support \
**une puce**  flea / silicon chip \
**engourdissement**  numbness; drowsiness; dullness \
**s'aliter**  to take to one's bed \
**au grand dam de**  at the displeasure of \
**la mousse**  moss / foam, lather / mousse \
**la sonnaille**  cowbell \
**faire des courbettes**  *fig.* to bow and scrape (**devant** to) \
**fermer les vannes**  to cut funding \
**pertuis**  *old* trou, ouverture ; passage \
**porc-épic**  porcupine \
**briguer**  to crave, set one's sights on \
**le pipeau**  (reed)-pipe / birdcall \
**se faire <u>rabrouer</u> par qn**  to be snubbed by sb \
**empester**  to stink, reek \
**l'assouplissement**   *(de cuir, linge)* softening / *(de règlement, politique)* relaxing \
**être bardé de médailles**  to be covered in medals \
**le panache**  also: plume (de fumée, d'eau) \
**fignoler**  to put the finishing touches to / to take great pains over \
**la houlette**  (de berger) crook / (d'évêque) crozier
**avec fougue**  with enthusiasm \
**décalage**  discrepancy, floor \
**la banquise**  ice floe / cold fish \
**un ban**  round of applause \
**rétif, -ve**  restive, rebellious \
**du bout des lèvres**  half-heartedly; grudgingly \
**lotir**   Partager en lots \
**(espèce de) fumier!**  you shit! \
**se prévaloir de**   to pride o.s. on \
**une solennité <u>ampoulée</u>**  bombastic solemnity \
**prélever**  to take a sample of [sang, eau]; to debit \
**CDI**  contrat à durée indéterminée \
**la guimbarde**  *(old car)* banger, crate \
**casseur**  scrap merchant; rioting demonstrator; burglar \
**moufter**  *slang* to protest \
**lancinant**  nagging \
**ne pas piper (mot)**  not to say a word (de about) \
**sa poule**   his woman \
**un brouillon**  rough draft \
**copier-coller**  copy-and-paste \
**gabarit**  size; calibre; template \
**scorie**  slag, dross \
**être sur les rotules**  *inf.* to be on one's last legs \
**essuyer**  to dry, to wipe \
**prendre qn en traître**   to take sb by surprise \
**à la niche**  *fig.* make yourself scarce! \
**une entreprise de petite envergure**  small-scale enterprise \
**démêlé**  wrangle \
**vaquer** [tribunal, assemblée] to be in recess; [cours] to stop \
**poisseux**  sticky, muggy \
**pêchu**  energetic; punchy \
**fosse d'aisances**   earth closet \
**il leur en a fait baver**  *inf* he gave them a hard time \
**benne à ordures**  dumpster truck \
**gifler**  to slap / [pluie, vent] to lash \
**cribler qn/qch de balles**  to riddle sb/sth with bullets \
**embonpoint**  (état) stoutness; (ventre) bulge ▸ avoir de l'embonpoint \
**la ristourne**  discount, rebate \
**rocambolesque**  fantastic, incredible \
**décrochage**  Av. stalling; (school) truancy \
**ne pas desemplir**  to be full \
**désobligeant**  discourteous \
**voilà le hic**  there's the snag \
**convier qn à qch**  to invite sb to sth \
**pot-aux-roses**  skeleton in the closet \
**saper**  to undermine, dress \
**saper**  to undermine (cliff, wall) \
**chien renifleur**  sniffer dog \
**être à deux doigts de qch/de faire**  to be a whisker away from sth/doing \
**outre-Quiévrain**  (Belg.) = France \
**dire les grâces**   to say grace (after a meal) \
**voyage d'agrément**  pleasure trip \
**le papelard**  *inf.* paper \
**fougère**  fern, bracken \
**non-lieu**   dismissal (of a charge) \
**une étamine**  stamen / muslin \
**écervelé**  featherbrain \
**la buvette**  *(de gare, fête)* refreshment area \
...
**mener qn à la baguette**  *fig.* to rule sb with a rod of iron \
**être fort aise de faire**   to be very pleased (to do) \
**mettre un aspect en exergue**  to highlight an aspect \
**s'enliser dans**  to get bogged down in, get stuck in \
**la lubie**  whim \
**dépouille mortelle** (cadavre) mortal remains \
